...
rxvt -si +sw -lsp 0 +sb -bg 0 -b 0 -w 0 -j -g 130x60  -pixmap "tests/dataPhoenix/backsky02.jpg" -fn "xft:FantasqueSansMono-Regular:pixelsize=9" -e ./tests/phoenix $1 $2 $3 $4
# -sbg
